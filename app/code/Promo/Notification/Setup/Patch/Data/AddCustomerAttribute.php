...
namespace Promo\Notification\Setup\Patch\Data;
...
class AddCustomerAttribute implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'notification_received', [
            'type' => 'varchar',
            'input' => 'text',
            'required' => false,
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'notification_viewed', [
            'type' => 'varchar',
            'input' => 'text',
            'required' => false,
        ...
        $newAttribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'notification_received');
        $newAttribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'notification_viewed');
